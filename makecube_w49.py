...
center = coordinates.SkyCoord('19:10:14.112   +09:06:13.87', unit=('hour','deg'))


for row in line_table:
    cubename='W49_{line}_cube'.format(line=row['Species'])
    # 1.5 x 1.5 '
    ...
    #         ]
    files = ([os.path.join(paths.AGBT15A_446_3_path, fn) for fn in
              ('15A_446_3_140to166_G1_0_F2.fits',
               '15A_446_3_84to114_G1_0_F2.fits',
               '15A_446_3_140to166_G2_0_F2.fits',
               '15A_446_3_84to114_G2_0_F2.fits',
              )])
    ...
    files = ([os.path.join(paths.AGBT15A_446_3_path, fn) for fn in
              ('15A_446_3_140to166_C1_0_F1.fits',
               '15A_446_3_84to114_C1_0_F1.fits',
               '15A_446_3_140to166_C2_0_F1.fits',
               '15A_446_3_84to114_C2_0_F1.fits',
              )])
    ...
    cubename='W49_ExtraFeed_{line}_cube'.format(line=row['Species'])
...
for row in line_table:
    for prefix in ("W49", "W49_ExtraFeed"):
