...
x,y = np.loadtxt('W51_Feed1_scan74', skiprows=3).T
...
sp_rest.plotter.savefig("W51_LineIDs_72GHz.png")

x,y = np.loadtxt('W49N_IF1_scan120', skiprows=3).T
...
spw49_rest.plotter.savefig("W49N_LineIDs_72GHz.png")
